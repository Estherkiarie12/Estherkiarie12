...
<body>
   ...
   <section class="gallery min-vh-100">
        <div class="container">
            <h1 class="text-center text mt-3 display-3 fw-bold">Gallery</h1>
        ...
        <div class="container">
            <div class="row gy-4 row-cols-1 row-cols-sm-2 row-cols-md-3">
               <div class="col">
                  <img src="img/img1.jpg" class="gallery-item" alt="gallery">
               </div>
               <div class="col">
                  <img src="img/img1.jpg" class="gallery-item" alt="gallery">
               </div>
               ...
               <div class="col">
                  <img src="img/img3.jpg" class="gallery-item" alt="gallery">
               </div>
            </div>
        </div>
    </section>
